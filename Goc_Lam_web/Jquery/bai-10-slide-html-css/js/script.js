$(document).ready(function() {
   $('#btn-next').click(function(event) {
      // .next(): xác định thành phần cùng cấp ngay kế tiếp thành phần sử dụng
      var slide_sau = $('.active').next();
      // console.log(slide_sau.length);
      if(slide_sau.length!=0){         //one... sau khi chạy animation removeClass
   ...
   $('#btn-prev').click(function(event) {
      ...
      if(slide_truoc.length!=0){         //one... sau khi chạy animation removeClass
